...
from parliamentarian import UnknownActionException, UnknownPrefixException
...
class TestActionExpansion:
    ...
    def test_expand_action_with_permission_only_action(self):
        ...
        assert len(expanded_actions) == len([{"service": "logs", "action": "GetLogDelivery"}])
