...
class TestFormatting:
    ...
    def test_analyze_policy_string_not_json(self):
        ...
        assert policy.finding_ids == set(["MALFORMED_JSON"]), "Policy is not valid json"
    ...
    "Statement": {
        ...
        assert policy.finding_ids == set(["MALFORMED"])
    ...
    "Version": "2012-10-17" }"""
        ...
        assert policy.finding_ids == set(["MALFORMED"]), "Policy has no Statement"
    ...
    "Statement": {
        ...
        assert policy.finding_ids == set(["MISMATCHED_TYPE"]), "First condition is bad"
    ...
    "Statement": {
        ...
        assert policy.finding_ids == set(["MISMATCHED_TYPE"]), "Operator type mismatch"
    ...
    "Statement": [
        ...
        assert policy.finding_ids == set(["DUPLICATE_SID"])
    ...
    "Statement": {
        ...
        assert policy.finding_ids == set([]), "Policy is valid"
